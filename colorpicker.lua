...
function colorpicker.load()
	...
	colorpicker.rtext = gooi.newLabel():setGroup("colorpicker"):setAlign("center"):setStyle(window)
	colorpicker.gslider = gooi.newSlider({value = 0}):setGroup("colorpicker")
	colorpicker.gslider.bgColor = colors.secondary
	colorpicker.gtext = gooi.newLabel():setGroup("colorpicker"):setAlign("center"):setStyle(window)
	colorpicker.bslider = gooi.newSlider({value = 0}):setGroup("colorpicker")
	colorpicker.bslider.bgColor = colors.quadary
	colorpicker.btext = gooi.newLabel():setGroup("colorpicker"):setAlign("center"):setStyle(window)
