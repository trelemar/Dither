...
function gui.load()
	...
	gooi.setStyle(list)
	filemenu:add(gooi.newButton("New File"):setOrientation("right"):setIcon("icons/black/ic_plus.png"):setGroup("filemenu"):onRelease(function() gui.toggleFileMenu() newdata:mapPixel(pixelFunction.allwhite) end), "2,1")
	filemenu:add(gooi.newButton({text = "Open File"}):setOrientation("right"):setIcon("icons/black/ic_file.png"):setGroup("filemenu"), "3,1")
	filemenu:add(nB("Save File"):setOrientation("right"):setIcon("icons/black/ic_content_save.png"):setGroup("filemenu"), "4,1")
